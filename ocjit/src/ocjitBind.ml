...
let jit_type_float32' = foreign_value "jit_type_float32" jit_type
...
let jit_type_float32 = !@ jit_type_float32'
...
let sys_double_param value = allocate double value
    |> to_voidp

let sys_int_param value = allocate int value
    |> to_voidp

let float32_return = allocate float 0.0

let sys_char_return = allocate char '0'

let sys_double_return = allocate double 0.0

let sys_int_return = allocate int 0
